					...
					<div className="left-view">
						<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
							<GithubStatsCard>
								...
								<div className="img">
									<Image src="https://github.com/JankAnna/JankAnna-portfolio/blob/main/public/img/user-photo.jpg" alt={language.aboutMePage.alt_dev_img} layout="fill" objectFit="cover" className="image-rounded" />
								</div>
